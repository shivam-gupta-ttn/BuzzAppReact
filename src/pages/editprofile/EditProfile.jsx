...
const EditProfile = (props) => {
    ...
    const [editUser, seteditUser] = useState({
        fname: props.user.name ? props.user?.name : "",
        lname: "",
        designation: "",
        website: "",
        gender: "",
                    ...
                    <div className="userForm">
                        <form onSubmit={onSubmitHandler} className="userFormInfo">
                            <div className="formFormat">
                                ...
                                <input type="text" placeholder="" value={editUser.fname} name="fnam" onChange={(e) => onChangeHandler(e, "fname")} />
